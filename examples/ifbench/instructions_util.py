...
# Monkey-patch nltk.word_tokenize so punkt data is not required.
# RegexpTokenizer(\w+) is equivalent for our word-count/keyword checks.
...
def count_sentences(text):
    """Count the number of sentences using regex (no punkt data needed)."""
